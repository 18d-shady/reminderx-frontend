  ...
  return (
    <>
      ...
      <div className="p-4 w-full overflow-x-hidden font-mono flex flex-col space-y-7">
        ...
        <div className="rounded-md border border-gray-400 p-4 flex justify-between items-center">
          <div className="flex items-center space-x-4">
            <div className="relative">
              ...
              {showImageOptions && (
                <div ref={imageOptionsRef} className="absolute top-full left-0 mt-2 bg-white dark:bg-gray-950 rounded-lg shadow-lg border border-gray-200 py-2 w-32 z-10">
                  <button
          ...
          {/* Show error below profile picture if any */}
          {saveError && (
        ...
        {showProfileEdit && (
          <div className="border rounded p-4 space-y-2 bg-gray-50 dark:bg-gray-950">
